...
แตะ/คลิกป้ายซิงก์เพื่อเปิดรายละเอียดเต็ม (หรือ hover บนเดสก์ท็อป)

| จุด | ป้ายสั้น | รายละเอียดเต็ม (tooltip) |
|---|---|---|
| 🟢 | Supabase | เชื่อมต่อกับ Supabase แล้ว — ข้อมูลซิงก์อัตโนมัติ |
| 🟠 กะพริบ | กำลังเชื่อมต่อ… | กำลังเชื่อมต่อกับ Supabase… |
| 🔴 | เชื่อมต่อล้มเหลว | สิทธิ์ไม่พอ (RLS) — ต้องรัน migration ใน repo |
| ⚪ | โหมดเครื่อง | โหมดเครื่อง (ออฟไลน์) — ยังไม่ได้ตั้งค่า Supabase ข้อมูลอยู่ในเครื่องนี้ |
| ⚪ | โหมดผู้เยี่ยมชม | โหมดผู้เยี่ยมชม — ข้อมูลอยู่ในเครื่องนี้เท่านั้น ล็อกอินเพื่อซิงก์ข้ามเครื่อง |
